...
Chatmanager::Chatmanager(EleaphRpc *eleaphRpc, Usermanager* managerUser, QObject *parent) : QObject(parent)
{
    ...
    // protocol handlers
    this->eleaphRpc->registerRpcMethodWorker(PACKET_DESCRIPTOR_CHAT_PRIVATE, this, SLOT(handlePrivateChatMessage(EleaphRPCDataPacket*)), false, EleaphRpcPacketMetaEvent_Before(this->managerUser, "metaEventUserLoggedInCheck"));
}
